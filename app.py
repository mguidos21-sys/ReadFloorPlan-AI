...
def crear_dxf_integral(datos):
    ...
    msp.doc.layers.add("ANOTACIONES_LINEAS", color=7)
    ...
    for i, t in enumerate(tramos):
        ...
        if dist > 0:
            ...
            msp.add_text(f"L{i+1}", 
                        dxfattribs={
                            'height': 0.8, 
                            'layer': 'ANOTACIONES_LINEAS',
                            'color': 3 # Verde brillante para Linderos en el dibujo
                        }).set_placement((mid_x + 0.3, mid_y + 0.3)) 
    ...
    # NOTA EXPLICATIVA DE LA LÍNEA ROJA (Pedagógica, sin Emojis)
